...
Route::post('komentar/{id}', 'KomentarController@komentar')->middleware('jwt.verify');
//buat ngasih komentar berdasarkan id yang login
...
// message
Route::get('allmessage', 'MessageController@index')->middleware('jwt.verify');
//ambil semua pesan
Route::get('/message/{id}', 'MessageController@getMessage')->middleware('jwt.verify');
// buat nge get pesan
